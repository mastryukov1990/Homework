...
def fucking_fish(x0, y0, N):
    N=N/2
    brushColor('red')
    polygon([(x0+31/N, y0+9/N), (x0+45/N, y0), (x0+39/N, y0+20/N), (x0+31/N, y0+9/N)])#tail

    line(x0-3/N, y0+9/N, x0-5/N, y0)
    brushColor('red')
    polygon([(x0-3/N, y0+9/N), (x0-5/N, y0-10/N), (x0+5/N, y0-7/N), (x0, y0+9/N), (x0-3/N, y0+9/N)])#плавник левый нижний
    polygon([(x0-5/N, y0+9/N), (x0-10/N, y0+30/N), (x0, y0+26/N), (x0-2/N, y0+9/N), (x0-5/N, y0+9/N)])#плавник правый нижний
    polygon([(x0+5/N, y0+9/N), (x0+5/N, y0+30/N), (x0+10/N, y0+26/N), (x0+8/N, y0+9/N), (x0+5/N, y0+9/N)])#плавник верхний

    brushColor('grey')
    ellips(30/N, 10/N, x0+5/N, y0+10/N)#body

    brushColor('blue')
    ellips(5/N, 5/N, x0-7/N, y0+9/N)#eye
    brushColor('white')
    ellips(2/N, 2/N, x0-7/N, y0+9/N)#in_eye
...
brushColor('yellow')
ellips(100, 100, 600, 100)#sun
brushColor('blue')
ellips(90, 90, 600, 100)#blue_in_sun
brushColor('yellow')
polygon([(600, -1), (600, 200), (610, 200), (610, 0)])
polygon([(500, 100), (700, 100), (700, 110), (500, 110)])
run()
